...
def is_injective(A, B, f):
    ...
    Note: in this case, the parameters are not necessary and not even used.
    However, they are included for uniformity with the questions you have to answer in the lab.
